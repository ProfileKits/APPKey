...
public class VIJOZInvoke {
    ...
    public boolean init(Context context, String key, int date, int type, int time) {
        this.context = context;
        boolean k = VIJOZJNI.getToken(context, key, date, type, time);
        return k;
    }
    ...
    public String getSign(Context context) {
        return VIJOZJNI.getKey(context);
    }
